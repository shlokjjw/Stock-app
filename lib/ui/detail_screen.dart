...
import 'package:flutter_application_4/bloc/candles_bloc.dart';
import 'package:flutter_application_4/bloc/price_info_bloc.dart';
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_)=> CandleBloc..add(CandlesEventStated(instrument, granularity),
        ),
        ),
                ...
                child: BlocBuilder<CandlesBloc, CandlesState>(
                  builder: (context, state){
                    if(state is CandlesLoading){
                      ...
                      List<CandleData> candleData = createChartData(candles.candles);
                        return Padding(
                                ...
                                Container(
                                  ...
                                  child: SfCartesianChart(
                                    primaryXAxis: DateTimeAxis(
                                      ...
                                      visibleMaximum: candleData[candleData.length()-1].x,
                            ...
                            children: <Widget>[
                              Container(
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      'Intrument ${price.instrument}'.replaceAll('_', ' / '),
                                      style: TextStyle(
                                    ...
                                    Text(
                                      'Spread ${calSpread(double.parse(price.closeoutBid))}',
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: Colors.black54
                                      ),
                                    ...
                                    Column(
                                      ...
                                      children: <Widget>[
                                        Container(
                                          ...
                                          child: Text(
                                            'Date ${price.time}'.split('.')[0].replaceAll('T', ' '),
                                            style: TextStyle(
                                              color: Colors.black54,
                                            ),
                                          ),
